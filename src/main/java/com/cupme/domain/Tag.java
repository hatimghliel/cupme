...
public class Tag implements Serializable {
    ...
    public Tag(Long id, String name, Set<Protocol> protocols, Set<Product> products) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(getProtocols(), tag.getProtocols()) &&
            Objects.equals(getProducts(), tag.getProducts())
        );
    }
